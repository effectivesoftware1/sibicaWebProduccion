...
<nav class="mb-1 navbar navbar-expand-lg navbar-expand-md navbar-expand-sm navbar-dark default-color menu-var-sibica">
  <span class="fas fa-angle-double-left icon-ws-menu" id="icon_menu"></span>
  <!--ininio ul-->
  <div class="navbar-collapse menu-var-content-sibica" id="navbarSupportedContent-333" style="display:none !important;">
    <div class="sidebar-nav ml-auto nav-flex-icons">
      <li class="nav-item navbar-nav"><a href="#"><div><img src="./asset/public/img/logo_sibica.jpg" style="width:50px;height:50px;"></div></a>  </li><br>
      <li class="nav-item navbar-nav menu-circle-collase width_px_50 class-column" id="li_contend_admin" style="display:none;">
          ...
          <div id="menu_admin" class="navbar-nav ml-auto nav-flex-icons oculta_elemnt class-column" style="margin-right: 3px;">
            <a id="modpanorama" href="#" onclick="gestionarPanorama();" data-toggle="collapse" data-target="#collapse-modPanorama" aria-expanded="false" aria-controls="collapse-modPanorama" title="Gestion panoramas de riesgo" class="collapsed circle-menu panorama-key-css">
             ...
             <a id="modpanorama" href="#" onclick="gestionarVisitas();" data-toggle="collapse" data-target="#collapse-modPanorama" aria-expanded="false" aria-controls="collapse-modPanorama" title="Gestio&oacute; de visitas t&eacute;cnicas" class="collapsed circle-menu panorama-key-css">
              <span class="fa fa-window-restore"></span>
              <span class="text">Gestio&oacute; de visitas t&eacute;cnicas</span>
            </a>
            <a id="modmanual" href="#" onclick="descargarManual();" data-toggle="collapse" data-target="#collapse-modPanorama" aria-expanded="false" aria-controls="collapse-modPanorama" title="Manual sibica" class="collapsed circle-menu oculta_elemnt doc-manual-key-css">
