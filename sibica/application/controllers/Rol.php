<?php 
  ...
  class Rol extends CI_Controller{
	...
	public function guardarPermisosRol(){
		$this->Utilidades_model->validaSession();
		$codigoRol = $this->input->post("cod_rol");
		$permisos = json_decode($this->input->post("registros"), true);//$this->input->post("permisos");
		//$permisos = $this->input->post("iteracion");
	...
	public function guardarPermisosRolCampo($codModuloPermiso, $arrCampos){
		$this->Utilidades_model->validaSession();
