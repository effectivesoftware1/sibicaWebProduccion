  ...
  class Panorama_riesgos extends CI_Controller{
	...
	public function llamarTareaPanorama(){
		...
		if($existePanorama){
			...
			$frmParam['estado_tr'] = $this->Utilidades_model->generarComboWhere('','public.estado', 'id_estado', 'nombre_estado', '1','','id_estado IN(3,4,9,11)', true, $clases_estado);
			...
			$frmParam['proteccion_tr'] = isset($objDato['proteccion']) ? $objDato['proteccion'] : '0';
			...
			$resultado['frm_tarea'] = 'Estimado usuario, por favor asegurese de haber guardado primero el panorama.';
			$resultado['tbl_tarea'] = '';
	...
	public function llamarSeguimientoTarea(){
		...
		$frmParam['attrDisabled'] = '';
		$frmParam['codPanorama_sg'] = isset($objDato['codPanorama']) ? $objDato['codPanorama'] : '';
		$frmParam['codTarea_sg'] = isset($objDato['codTarea']) ? $objDato['codTarea'] : '';
		$frmParam['titulo_sg'] = isset($objDato['tituloTarea']) ? $objDato['tituloTarea'] : '';
		$frmParam['codSeguimiento_sg'] = isset($objDato['codSeguimiento']) ? $objDato['codSeguimiento'] : '';
		$frmParam['estado_sg'] = $this->Utilidades_model->generarComboWhere('','public.estado', 'id_estado', 'nombre_estado', '2','Seleccione estado','id_estado IN(3,4,9,11)', true, $clases_estado);
	...
	function getTablaTareasPanorama($codPanorama){
		$columnasTarea = $this->Utilidades_model->columnCbz('tarea_panorama');
		$dataArr = array();
